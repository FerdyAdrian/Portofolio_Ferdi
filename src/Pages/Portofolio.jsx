  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        localStorage.setItem("projects", JSON.stringify(projectData)); // Save projects to localStorage
        ...
        localStorage.setItem("certificates", JSON.stringify(certificateData)); // Save certificates to localStorage
      } catch (error) {
