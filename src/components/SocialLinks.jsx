...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/ferdi-adrian-yudistira/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@ferdyuda2",
    icon: Instagram,
    url: "https://www.instagram.com/ferdyuda2/",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@FerdyAdrian",
    icon: Github,
    url: "https://github.com/FerdyAdrian",
    color: "#ffffff",
